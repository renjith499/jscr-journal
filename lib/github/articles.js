...
function normalizeAssetPath(path, config) {
  ...
  if (path.startsWith("/images/") || path.startsWith("/pdfs/")) return path;
  if (path.startsWith("/assets/images/")) return path.replace("/assets/images/", "/images/");
  if (path.startsWith("/assets/pdfs/")) return path.replace("/assets/pdfs/", "/pdfs/");
  if (path.startsWith("/assets/pdf/")) return path.replace("/assets/pdf/", "/pdfs/");
