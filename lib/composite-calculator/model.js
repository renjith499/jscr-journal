...
export function calculateComposite(input) {
  ...
  const E1 = axial("E1", "E1", "E₁ = V_f E₁f + V_m E₁m");
  const E2 = transverse("E2", "E2", "1/E₂ = V_f/E₂f + V_m/E₂m");
  const E3 = transverse("E3", "E3", "1/E₃ = V_f/E₃f + V_m/E₃m");
  const G12 = transverse("G12", "G12", "1/G₁₂ = V_f/G₁₂f + V_m/G₁₂m");
  const G13 = transverse("G13", "G13", "1/G₁₃ = V_f/G₁₃f + V_m/G₁₃m");
  const G23 = transverse("G23", "G23", "1/G₂₃ = V_f/G₂₃f + V_m/G₂₃m");
  const nu12 = axial("nu12", "ν12", "ν₁₂ = V_fν₁₂f + V_mν₁₂m");
  const nu13 = axial("nu13", "ν13", "ν₁₃ = V_fν₁₃f + V_mν₁₃m");
  const nu23 = axial("nu23", "ν23", "ν₂₃ = V_fν₂₃f + V_mν₂₃m");
...
export function abaqusText(input, model) {
  ...
  const lines = [
    ...
    `** Rule-of-mixtures preliminary estimates`,
