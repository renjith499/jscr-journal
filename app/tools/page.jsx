    ...
    <main className="min-h-[75vh] bg-paper px-5 py-16 dark:bg-slate-950 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          {tools.map(({ title, href, text, Icon, badge }) => (
            <Link
              key={title}
              href={href}
        ...
        <div className="mt-8 flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-4 text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
