import { CalendarDays, Download, FileCode2, GitBranch, Share2, UserRound } from "lucide-react";
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-5 lg:grid-cols-[minmax(0,1fr)_320px] lg:px-8">
        <article className="rounded-lg border border-slate-200 bg-white p-6 shadow-soft dark:border-slate-700 dark:bg-slate-900 lg:p-9">
          <div className="mb-5 flex flex-wrap gap-2">
            ...
            <span className="rounded-md bg-slate-100 px-3 py-1.5 text-xs font-bold text-slate-600 dark:bg-slate-800 dark:text-slate-300">
              {sourceStatus === "github" ? "Loaded from GitHub" : "Sample article"}
            </span>
          </div>
