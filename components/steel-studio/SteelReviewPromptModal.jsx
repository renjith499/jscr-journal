...
import { submitSteelFeedback } from "@/lib/steel-studio/feedback";

const GOOGLE_REVIEW_URL = "https://g.page/r/CQ1bDJ3g_c2vEBM/review";

export function SteelReviewPromptModal({ email, onClose }) {
  ...
  async function handleSend() {
    ...
    try {
      await submitSteelFeedback(feedback, email);
      ...
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-soft dark:bg-slate-900">
        <div className="mb-4 flex items-start justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-extrabold text-primary dark:text-white">Enjoying the Steel Calculator?</h3>
          </div>
